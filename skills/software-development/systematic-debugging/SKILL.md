...
- **Python debugging** — see [references/python-debugging.md](references/python-debugging.md) for `pdb`, `breakpoint()`, `remote-pdb`, and `debugpy` DAP-based debugging
- **Node.js debugging** — see [references/node-debugging.md](references/node-debugging.md) for `node inspect` REPL and Chrome DevTools Protocol inspection
