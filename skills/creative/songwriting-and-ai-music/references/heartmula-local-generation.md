...
> **Originally a standalone skill `heartmula`; consolidated into `songwriting-and-ai-music` as a reference.**
> HeartMuLa is the local/offline alternative to Suno. Use Suno (sections 6-8 in the parent SKILL.md) for cloud-based creative work. Use this guide when you need privacy, offline capability, or want to avoid API costs.
